  ...
  return (
    <div className='group/feature text-foreground flex flex-col gap-4 p-4'>
      ...
      <div className='flex items-center self-start'>
        <div className='flex h-10 w-10 items-center justify-center rounded-xl bg-gradient-to-br from-amber-500/20 to-amber-600/10 shadow-inner ring-1 ring-amber-500/20 transition-[transform,box-shadow] duration-[var(--duration-panel)] ease-[var(--ease-out)] group-hover/feature:scale-105 group-hover/feature:ring-amber-500/40'>
          {icon}
        </div>
      </div>
      {/* Title */}
