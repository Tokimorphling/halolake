...
function DropdownMenuSubContent({
  ...
  return (
    <DropdownMenuContent
      ...
      className={cn(
        'bg-popover text-popover-foreground ring-foreground/8 data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2 data-open:animate-in data-open:fade-in-0 data-open:zoom-in-95 data-closed:animate-out data-closed:fade-out-0 data-closed:zoom-out-95 w-auto min-w-[96px] rounded-xl p-1 shadow-[0_8px_30px_oklch(0_0_0/0.12)] ring-1 duration-[var(--duration-fast)] ease-[var(--ease-out)]',
        className
      )}
      align={align}
      alignOffset={alignOffset}
